...
**Project and data** The intentiopn of this R Markdown is to prepare a dataset that Master Students of BatLab Norway part of the 2024-2025 academic year can use for ECOL340 exercises in the autumn of 2024. These datasets are made up of bat acoustic data automatically processed by Kaleidoscope Pro (v.5.6.3) with the Bats of Europe Classifier (v.5.4.0) modified to only include species included on the Norwegian National Red List (from CM-03, CM-07 (coastal monitoring sites), ST-01, and ST-02 (wind turbine sites at Stigafjellet wind farm) collected during the 2024 field season. Each observation (row) represents a 5 second (a few may be slightly shorter) acoustic recording (bat pass - though it may not contain a bat at all i.e., a noise file yet to be identified). Recordings that the classifier identifies as noise will be removed and treated as non-bat passes. We will then assume that the rest of the recordings do include bats, though false positives are likely without a manual acoustic analysis to verify these classifications. Mis-identification of bat species is also very likely and so this data cannot be treated as actual bat observations without further analysis. The objective of preparing this data is to give masters students experience working with bat acoustic datasets. 
